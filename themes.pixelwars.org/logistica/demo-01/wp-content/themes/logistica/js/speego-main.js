...
(function () {
  ...
  const i18nData = {
    en: {
      ...
      sourcing_eyebrow: 'SOURCING & QUALITY CONTROL',
      sourcing_title_main: 'The right supplier.',
      sourcing_title_accent: 'Confidence in every shipment.',
      sourcing_intro: 'SpeeGo helps you find suitable manufacturers, assess their capabilities, negotiate terms and inspect product quality before shipment.',
      sourcing_step1_title: 'Find & verify suppliers',
      sourcing_step1_desc: 'Choose suitable partners and assess production capabilities.',
      sourcing_step2_title: 'Negotiate price & MOQ',
      sourcing_step2_desc: 'Clarify pricing, minimum order quantities and terms.',
      sourcing_step3_title: 'Control product quality',
      sourcing_step3_desc: 'Follow production and inspect products before shipping.',
      sourcing_cta: 'Discuss your needs ↗',
      sourcing_more: 'Explore the service →',
      sourcing_visual_title: 'From factory to market',
      sourcing_visual_desc: 'One point of contact throughout your sourcing journey.',
    ...
    vi: {
      ...
      sourcing_intro: 'SpeeGo đồng hành từ tìm nhà sản xuất phù hợp, xác minh năng lực và đàm phán điều khoản đến kiểm tra chất lượng trước khi xuất hàng.',
      sourcing_step1_title: 'Tìm & xác minh nhà cung cấp',
      sourcing_step1_desc: 'Lựa chọn đối tác phù hợp và đánh giá năng lực sản xuất.',
      sourcing_step2_title: 'Đàm phán giá & MOQ',
      sourcing_step2_desc: 'Hỗ trợ làm rõ giá, số lượng tối thiểu và điều khoản hợp tác.',
      sourcing_step3_title: 'Kiểm soát chất lượng',
      sourcing_step3_desc: 'Theo dõi sản xuất và kiểm tra sản phẩm trước khi xuất hàng.',
      sourcing_cta: 'Trao đổi nhu cầu ↗',
      sourcing_more: 'Xem chi tiết dịch vụ →',
      sourcing_visual_title: 'Từ nhà máy đến thị trường',
      sourcing_visual_desc: 'Một đầu mối xuyên suốt hành trình nguồn hàng.',
    ...
    es: {
      ...
      sourcing_intro: 'SpeeGo ayuda a encontrar fabricantes adecuados, evaluar su capacidad, negociar condiciones y revisar la calidad antes del envío.',
      sourcing_step1_title: 'Buscar y verificar proveedores',
      sourcing_step1_desc: 'Elegir socios adecuados y evaluar su capacidad de producción.',
      sourcing_step2_title: 'Negociar precio y pedido mínimo',
      sourcing_step2_desc: 'Aclarar precios, cantidades mínimas y condiciones.',
      sourcing_step3_title: 'Controlar la calidad',
      sourcing_step3_desc: 'Seguir la producción e inspeccionar antes del envío.',
      sourcing_cta: 'Cuéntanos tu necesidad ↗',
      sourcing_more: 'Ver el servicio →',
      sourcing_visual_title: 'De la fábrica al mercado',
      sourcing_visual_desc: 'Un único punto de contacto durante todo el proceso.',
